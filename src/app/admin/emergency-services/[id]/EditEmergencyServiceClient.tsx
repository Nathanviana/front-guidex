...
export default function EditAccommodationClient({ id }: Props) {
  ...
  useEffect(() => {
    const fetchEmergencyService = async () => {
      try {
        ...
        const response = await axios.get(`/emergency-services/${id}`);
  ...
  const handleDelete = async () => {
    if (
      !window.confirm(
        "Are you sure you want to delete this emergency service? This action cannot be undone."
      )
    ) {
      return;
    }
    ...
    try {
      await axios.delete(`/emergency-services/${id}`);
      router.push("/admin/emergency-services");
    } catch (err: any) {
  ...
  const currentTypeConfig = emergencyService
    ? serviceTypeConfig[
        emergencyService.type as keyof typeof serviceTypeConfig
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {emergencyService && (
              <>
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {new Date(emergencyService.createdAt).toLocaleDateString()}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-sm">
                    {new Date(emergencyService.updatedAt).toLocaleDateString()}
                  </p>
                </div>
              </>
            )}
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Update the emergency service information
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  Provide the complete address including city and state
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  Include any special services, languages spoken, or important
                  notes
                </p>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <p className="text-sm text-red-700">
                  Please verify all contact information before updating.
                  Incorrect emergency contact details could be life-threatening.
                  Always test phone numbers and confirm addresses.
                </p>
              </div>
            </CardContent>
